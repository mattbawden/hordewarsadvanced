 ...
 */
const environment = {
  attributes:{"sheet_version":"0","hordewarsadvanced_tab":"nav-tabs-hordewarsadvanced--character","header":"","template_start":"@{whisper}&{template:hordewarsadvanced} {{character_name=@{character_name}}} {{character_id=@{character_id}}}"},
  triggers: [],
  translation,
  otherCharacters: {
